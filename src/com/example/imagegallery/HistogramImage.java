...
public class HistogramImage extends RelativeLayout implements OnTouchListener {
	...
	public HistogramImage(Context context, Bitmap b) {
		...
		/*
		RelativeLayout.LayoutParams imageParamsM = new RelativeLayout.LayoutParams(
				RelativeLayout.LayoutParams.WRAP_CONTENT,
				RelativeLayout.LayoutParams.WRAP_CONTENT);
		imageParamsM.addRule(RelativeLayout.LEFT_OF, 1);

		imageMaximize = new ImageView(ccontext);
		imageMaximize.setBackgroundResource(R.drawable.maximize);
		imageMaximize.setId(2);
		imageMaximize.setLayoutParams(imageParamsM);
		this.addView(imageMaximize);

		imageMaximize.setOnClickListener(new OnClickListener() {
		...
		RelativeLayout.LayoutParams imageParamsR = new RelativeLayout.LayoutParams(
				RelativeLayout.LayoutParams.WRAP_CONTENT,
				RelativeLayout.LayoutParams.WRAP_CONTENT);
		imageParamsR.addRule(RelativeLayout.LEFT_OF, 2);

		imageRestore = new ImageView(ccontext);
		imageRestore.setBackgroundResource(R.drawable.restore);
		imageRestore.setId(3);
		imageRestore.setLayoutParams(imageParamsR);
		this.addView(imageRestore);

		imageRestore.setOnClickListener(new OnClickListener() {
