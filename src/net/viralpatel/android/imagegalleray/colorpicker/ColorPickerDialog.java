...
public class ColorPickerDialog 
	...
	private void setUp(int color) {
		...
		bcolor = (Button) layout.findViewById(R.id.buttonColor);
		...
		bcolor.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//Toast.makeText(getContext(), "Boja: " + getColor(), Toast.LENGTH_LONG).show();
				Intent i = new Intent(getContext(), ImageGalleryDemoActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
